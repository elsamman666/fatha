...
import 'ReadingNewMuslimScreen.dart';
class ListningNewMuslimScreen extends StatefulWidget {
  String dept;
  int index;
  ListningNewMuslimScreen(this.dept,this.index);

  @override
  _ListningNewMuslimScreenState createState() => _ListningNewMuslimScreenState(this.index);
}

class _ListningNewMuslimScreenState extends State<ListningNewMuslimScreen> {
  int index;

  _ListningNewMuslimScreenState(this.index);
  ...
  Map ayat = {"records": [
    ...
    },
    {
      ...
      "aya": "صراط الذين أنعمت عليهم",
      "translatedverse": "The Way of those on whom You have bestowed Your Grace",
      "audio": "-",
      "prize": "10",
      "complete": "0"
    },
    {
      ...
      "ayahIndex": "8",
      "tokensCount": "9",
      "verse": "غَيْرِ ٱلْمَغْضُوبِ عَلَيْهِمْ وَلَاٱلضَّآلِّينَ",
      "aya": "غير المغضوب عليهم ولاالضالين",
      "translatedverse": "not (the way) of those who earned Your Anger (i.e. those whose intentions are perverted: they know the Truth, yet do not follow it), nor of those who went astray (i.e. those who have lost the (true) knowledge, so they wander in error, and are not guided to the Truth)",
      "audio": "-",
      "prize": "10",
      "complete": "0"
    }
              ...
              child: Stack(
                children: [
                  Container(
                    ...
                    child: Text(newLearn,style: TextStyle(color:Color(0xff707070),fontSize: 18,fontWeight: FontWeight.bold),),
                  ),
                  Container(
                    width: double.infinity,
                    height: 55,
                                  ...
                                  alignment: Alignment.center,
                                    child: SingleChildScrollView(
                                      child: Column(
                                        ...
                                        children: [
                                          Container(alignment:Alignment.center,child: Text(ayat['records'][index]['verse'], style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.purple),)),
                                          SizedBox(height: 10,),
                                          Text(ayat['records'][index]['translatedverse'],textAlign: TextAlign.center,style: TextStyle(color: Colors.grey,fontSize: index==6||index==7?13:15),)
                                        ],
                                      ),
                                    )
                                ),
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          onTap: ()async{
                            ...
                            Navigator.of(context).push(MaterialPageRoute(builder: (context)=>ReadingNewMuslimScreen(widget.dept,index,ayat['records'][index]['aya'],ayat['records'][index]['verse'],ayat['records'][index]['translatedverse'])));
                          },
                          child: Container(
                            height: 55,
                            ...
                            child: Text(readNow,style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
                          ),
                        ),
                      ),
                    )
