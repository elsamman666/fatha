              ...
              child: Stack(
                children: [
                  Container(
                    ...
                    child: Text(tr("newLearn"),style: TextStyle(color:Color(0xff707070),fontSize: 18,fontWeight: FontWeight.bold),),
                  ),
                  Container(
                    width: double.infinity,
                    height: 55,
                                    ...
                                    child: SingleChildScrollView(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 10,),
                                          Text(ayat['records'][index]['translatedverse'],textAlign: TextAlign.center,style: TextStyle(color: Colors.grey,fontSize: index==6?13:15),)
                                        ],
                                      ),
                                    )
                                ),
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            child: Text(tr("readNow"),style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
                          ),
                        ),
                      ),
                    )
