  ...
  void initState() {
    ...
    setState(() {
      ...
      if(widget.index==0){
        ...
        translatedverse="The condition-of those-you have blessed-you have blessed";
      }else if(widget.index==7){
        translatedverse = "not against-whom He is angry-whom He is angry-and not for the lost";
      }
                  ...
                  child: SingleChildScrollView(
                    child: ListBody(
                      children: <Widget>[
                        ...
                        SizedBox(height: 25,),
                        Text(rightReading,textAlign: TextAlign.center,style: GoogleFonts.elMessiri(textStyle:TextStyle(fontSize: 24,color: Color(0xff707070)),)),
                        SizedBox(height: 30,),
                        Container(
                          alignment: Alignment.center,
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              child: Text(nextVerse,style: GoogleFonts.elMessiri(textStyle:TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20),)),
                            ),
                          ),
                        ),
                        SizedBox(height: 45,),
                      ...
                      children: <Widget>[
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: Text(reReading,style: GoogleFonts.elMessiri(textStyle:TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23),)),
                          ),
                        ),
                        SizedBox(height: 10,),
                        Container(
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              child: Text(nextWord,style: GoogleFonts.elMessiri(textStyle:TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20),)),
                            ),
                          ),
                        ),
                        SizedBox(height: 45,),
