                        ...
                        children: [
                          ...
                          Expanded(
                              ...
                              child:InkWell(
                                  ...
                                  child: Image.asset("images/mice.png")
                              )
                          ),
                    ...
                    child: ListBody(
                      children: <Widget>[
                        ...
                        Text(tr("good"),
                          ...
                          textAlign: TextAlign.center,style: TextStyle(fontFamily: "ElMessiri",fontSize: 39,color: Color(0xff707070),fontWeight: FontWeight.bold),),
                        SizedBox(height: 25,),
                        Text(tr("rightReading"),textAlign: TextAlign.center,style: TextStyle(fontFamily: "ElMessiri",fontSize: 29,color: Color(0xff707070)),),
                        SizedBox(height: 30,),
                        Container(
                          alignment: Alignment.center,
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              child: Text(tr("nextVerse"),style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontFamily: "ElMessiri",fontSize: 23),),
                            ),
                          ),
                        ),
                        SizedBox(height: 45,),
                        ...
                        Container(
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              child: Text(tr("reReading"),style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontFamily: "ElMessiri",fontSize: 23),),
                            ),
                          ),
                        ),
                        SizedBox(height: 45,),
                        ...
                        Container(
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              child: Text(tr("backHome"),style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontFamily: "ElMessiri",fontSize: 23),),
                            ),
                          ),
                        ),
                        SizedBox(height: 45,),
